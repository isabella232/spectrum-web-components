    ...
    return (html) => {
        ...
        const finalHTML = postcss([
            ...
            .then((result) => {
                ...
                const removeShellHelperAfter = finalHTML.split(
                    '<helper class="shell-remove-after"></helper>'
                );
                finalHTML = removeShellHelperAfter[0];
                const removeShellHelperBefore = finalHTML.split(
                    '<helper class="shell-remove-before"></helper>'
                );
                finalHTML =
                    removeShellHelperBefore[removeShellHelperBefore.length - 1];
                return finalHTML;
            });
        return finalHTML;
    };
